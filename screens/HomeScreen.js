...
const styles = StyleSheet.create({
  ...
  proButton: { fontSize: 16, fontWeight: '600', color: '#e67e22', paddingHorizontal: 12, paddingVertical: 6, backgroundColor: '#fff', borderRadius: 20, borderWidth: 1, borderColor: '#e67e22' },
