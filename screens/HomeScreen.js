...
const styles = StyleSheet.create({
  ...
  scanButton: { backgroundColor: '#22c55e', paddingHorizontal: 18, paddingVertical: 10, borderRadius: 20 },
  scanButtonText: { fontSize: 20, color: '#000', fontWeight: 'bold', letterSpacing: 2 },
